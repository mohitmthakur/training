...
process HISAT2_ALIGN {
    ...
    publishDir "${params.outdir}/bam/unsorted", mode: 'symlink'
    ...
    output:
    tuple val(sampleId), path("${sampleId}.unsorted.bam"), emit: bam // Should be trimmed, but generic for other cases
    ...
    hisat2 -x ${index_zip.simpleName} -1 ${reads[0]} -2 ${reads[1]} \
        ...
        | samtools view -bS -o ${sampleId}.unsorted.bam
    """
}
